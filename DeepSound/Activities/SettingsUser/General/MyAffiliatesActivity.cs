    ...
    public class MyAffiliatesActivity : BaseActivity
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                TxtLink.Text = InitializeDeepSound.WebsiteUrl + "?ref=" + UserDetails.Username;
                ...
                switch (Convert.ToInt32(ListUtils.SettingsSiteList?.AmountPercentRef ?? "0"))
                {
                    case > 0:
                        ...
                        break;
                    default:
                        TxtMyAffiliates.Text = GetString(Resource.String.Lbl_EarnUpTo) + " " + ListUtils.SettingsSiteList?.CurrencySymbol + ListUtils.SettingsSiteList?.AmountRef + " " + GetString(Resource.String.Lbl_forEachUserYourReferToUs) + " !";
                        break;
                }
            }
            catch (Exception e)
