...
namespace DeepSound.Helpers.ShimmerUtils
{
    public class ShimmerTemplateLayout : LinearLayout
    {
        ...
        private void InitView(Context context, IAttributeSet attributeSet)
        {
            ...
            try
            {
                if (attributeSet != null)
                {
                    ...
                    TemplateType = attributes.GetResourceId(Resource.Styleable.TemplateShimmer_template_res, Resource.Layout.Style_RowSongsShimmerView);
        ...
        public void SetTemplateStyle(ShimmerTemplateStyle style)
        {
            try
            {
                ...
                switch (style)
                {
                    case ShimmerTemplateStyle.SongRowTemplate:
                        TemplateType = Resource.Layout.Style_RowSongsShimmerView;
                        break;
                    case ShimmerTemplateStyle.SongTemplate:
                        TemplateType = Resource.Layout.Style_SongsShimmerView;
                        break;
        ...
        public ShimmerTemplateStyle GetTemplateTypeName()
        {
            switch (TemplateType)
            {
                case Resource.Layout.Style_RowSongsShimmerView:
                    return ShimmerTemplateStyle.SongRowTemplate;

                case Resource.Layout.Style_SongsShimmerView:
                    return ShimmerTemplateStyle.SongTemplate;
