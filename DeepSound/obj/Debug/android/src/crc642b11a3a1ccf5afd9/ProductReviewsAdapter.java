...
public class ProductReviewsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Product.Adapters.ProductReviewsAdapter, DeepSound", ProductReviewsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ProductReviewsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Product.Adapters.ProductReviewsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public ProductReviewsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ProductReviewsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Product.Adapters.ProductReviewsAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
