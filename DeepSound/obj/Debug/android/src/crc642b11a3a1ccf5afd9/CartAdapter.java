...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Product.Adapters.CartAdapter, DeepSound", CartAdapter.class, __md_methods);
	}
	...
	public CartAdapter ()
	{
		...
		if (getClass () == CartAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Product.Adapters.CartAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public CartAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == CartAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Product.Adapters.CartAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
