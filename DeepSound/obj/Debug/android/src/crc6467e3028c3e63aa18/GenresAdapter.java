...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Genres.Adapters.GenresAdapter, DeepSound", GenresAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == GenresAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Genres.Adapters.GenresAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public GenresAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == GenresAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Genres.Adapters.GenresAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
