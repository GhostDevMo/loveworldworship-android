...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Ads.AdsFacebook+BannerAdListener, DeepSound", AdsFacebook_BannerAdListener.class, __md_methods);
	}
	...
	public AdsFacebook_BannerAdListener ()
	{
		...
		if (getClass () == AdsFacebook_BannerAdListener.class) {
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsFacebook+BannerAdListener, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}
	...
	public AdsFacebook_BannerAdListener (androidx.recyclerview.widget.RecyclerView p0)
	{
		super ();
		if (getClass () == AdsFacebook_BannerAdListener.class) {
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsFacebook+BannerAdListener, DeepSound", "AndroidX.RecyclerView.Widget.RecyclerView, Xamarin.AndroidX.RecyclerView", this, new java.lang.Object[] { p0 });
		}
	}
