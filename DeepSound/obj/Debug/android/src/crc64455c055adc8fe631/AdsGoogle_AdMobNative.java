...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Ads.AdsGoogle+AdMobNative, DeepSound", AdsGoogle_AdMobNative.class, __md_methods);
	}
	...
	public AdsGoogle_AdMobNative ()
	{
		...
		if (getClass () == AdsGoogle_AdMobNative.class) {
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsGoogle+AdMobNative, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}
