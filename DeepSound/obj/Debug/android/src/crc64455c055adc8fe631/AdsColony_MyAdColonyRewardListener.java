...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Ads.AdsColony+MyAdColonyRewardListener, DeepSound", AdsColony_MyAdColonyRewardListener.class, __md_methods);
	}
	...
	public AdsColony_MyAdColonyRewardListener ()
	{
		...
		if (getClass () == AdsColony_MyAdColonyRewardListener.class) {
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsColony+MyAdColonyRewardListener, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}
