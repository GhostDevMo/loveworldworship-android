...
public class ManageSessionsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.SettingsUser.Adapters.ManageSessionsAdapter, DeepSound", ManageSessionsAdapter.class, __md_methods);
	}


	public ManageSessionsAdapter ()
	{
		super ();
		if (getClass () == ManageSessionsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.SettingsUser.Adapters.ManageSessionsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public ManageSessionsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ManageSessionsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.SettingsUser.Adapters.ManageSessionsAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
