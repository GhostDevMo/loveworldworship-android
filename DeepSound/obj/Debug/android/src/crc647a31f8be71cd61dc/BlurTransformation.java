...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.CacheLoaders.BlurTransformation, DeepSound", BlurTransformation.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == BlurTransformation.class) {
			mono.android.TypeManager.Activate ("DeepSound.Helpers.CacheLoaders.BlurTransformation, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public BlurTransformation (android.content.Context p0)
	{
		super ();
		if (getClass () == BlurTransformation.class) {
			mono.android.TypeManager.Activate ("DeepSound.Helpers.CacheLoaders.BlurTransformation, DeepSound", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
