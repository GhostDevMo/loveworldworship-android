...
public class ImageCoursalViewPager
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.CacheLoaders.ImageCoursalViewPager, DeepSound", ImageCoursalViewPager.class, __md_methods);
	}


	public ImageCoursalViewPager ()
	{
		super ();
		if (getClass () == ImageCoursalViewPager.class) {
			mono.android.TypeManager.Activate ("DeepSound.Helpers.CacheLoaders.ImageCoursalViewPager, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}
