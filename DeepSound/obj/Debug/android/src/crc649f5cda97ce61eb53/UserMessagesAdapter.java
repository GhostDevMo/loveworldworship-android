...
public class UserMessagesAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Chat.Adapters.UserMessagesAdapter, DeepSound", UserMessagesAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == UserMessagesAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Chat.Adapters.UserMessagesAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public UserMessagesAdapter (crc642979606d1fca3b34.MessagesBoxActivity p0)
	{
		super ();
		if (getClass () == UserMessagesAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Chat.Adapters.UserMessagesAdapter, DeepSound", "DeepSound.Activities.Chat.MessagesBoxActivity, DeepSound", this, new java.lang.Object[] { p0 });
		}
	}
