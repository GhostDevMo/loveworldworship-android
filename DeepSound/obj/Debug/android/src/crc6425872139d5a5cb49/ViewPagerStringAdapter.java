...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Controller.ViewPagerStringAdapter, DeepSound", ViewPagerStringAdapter.class, __md_methods);
	}
	...
	public ViewPagerStringAdapter ()
	{
		...
		if (getClass () == ViewPagerStringAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Controller.ViewPagerStringAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}
