...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Albums.Adapters.HAlbumsAdapter, DeepSound", HAlbumsAdapter.class, __md_methods);
	}


	public HAlbumsAdapter ()
	{
		super ();
		if (getClass () == HAlbumsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Albums.Adapters.HAlbumsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public HAlbumsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == HAlbumsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Albums.Adapters.HAlbumsAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
