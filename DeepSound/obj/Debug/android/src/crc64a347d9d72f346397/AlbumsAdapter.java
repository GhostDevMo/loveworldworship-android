...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Albums.Adapters.AlbumsAdapter, DeepSound", AlbumsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == AlbumsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Albums.Adapters.AlbumsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public AlbumsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == AlbumsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Albums.Adapters.AlbumsAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
