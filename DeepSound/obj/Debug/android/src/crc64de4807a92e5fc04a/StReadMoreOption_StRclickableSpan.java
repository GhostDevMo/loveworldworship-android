...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Library.Anjo.SuperTextLibrary.StReadMoreOption+StRclickableSpan, DeepSound", StReadMoreOption_StRclickableSpan.class, __md_methods);
	}
	...
	public StReadMoreOption_StRclickableSpan ()
	{
		...
		if (getClass () == StReadMoreOption_StRclickableSpan.class) {
			mono.android.TypeManager.Activate ("DeepSound.Library.Anjo.SuperTextLibrary.StReadMoreOption+StRclickableSpan, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}
