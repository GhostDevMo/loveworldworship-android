...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Address.Adapters.AddressAdapter, DeepSound", AddressAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == AddressAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Address.Adapters.AddressAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public AddressAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == AddressAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Address.Adapters.AddressAdapter, DeepSound", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
		}
	}
