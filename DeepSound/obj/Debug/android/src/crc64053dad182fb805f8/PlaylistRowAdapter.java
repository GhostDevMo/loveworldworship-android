...
public class PlaylistRowAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Playlist.Adapters.PlaylistRowAdapter, DeepSound", PlaylistRowAdapter.class, __md_methods);
	}


	public PlaylistRowAdapter ()
	{
		super ();
		if (getClass () == PlaylistRowAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Playlist.Adapters.PlaylistRowAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public PlaylistRowAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == PlaylistRowAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Playlist.Adapters.PlaylistRowAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
