...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Event.Adapters.EventAdapter, DeepSound", EventAdapter.class, __md_methods);
	}
	...
	public EventAdapter ()
	{
		...
		if (getClass () == EventAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Event.Adapters.EventAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public EventAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == EventAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Event.Adapters.EventAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
