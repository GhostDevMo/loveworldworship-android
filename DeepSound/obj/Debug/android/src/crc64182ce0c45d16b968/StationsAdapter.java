...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Stations.Adapters.StationsAdapter, DeepSound", StationsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == StationsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Stations.Adapters.StationsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public StationsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == StationsAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Stations.Adapters.StationsAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
