...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Tabbes.Adapters.ActivitiesAdapter, DeepSound", ActivitiesAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ActivitiesAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Tabbes.Adapters.ActivitiesAdapter, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}

	public ActivitiesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ActivitiesAdapter.class) {
			mono.android.TypeManager.Activate ("DeepSound.Activities.Tabbes.Adapters.ActivitiesAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
