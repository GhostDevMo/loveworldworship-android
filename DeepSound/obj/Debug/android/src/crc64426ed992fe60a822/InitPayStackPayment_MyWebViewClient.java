...
public class InitPayStackPayment_MyWebViewClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Payment.InitPayStackPayment+MyWebViewClient, DeepSound", InitPayStackPayment_MyWebViewClient.class, __md_methods);
	}


	public InitPayStackPayment_MyWebViewClient ()
	{
		super ();
		if (getClass () == InitPayStackPayment_MyWebViewClient.class) {
			mono.android.TypeManager.Activate ("DeepSound.Payment.InitPayStackPayment+MyWebViewClient, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}
