...
public class InitPaySeraPayment_MyWebViewClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Payment.InitPaySeraPayment+MyWebViewClient, DeepSound", InitPaySeraPayment_MyWebViewClient.class, __md_methods);
	}


	public InitPaySeraPayment_MyWebViewClient ()
	{
		super ();
		if (getClass () == InitPaySeraPayment_MyWebViewClient.class) {
			mono.android.TypeManager.Activate ("DeepSound.Payment.InitPaySeraPayment+MyWebViewClient, DeepSound", "", this, new java.lang.Object[] {  });
		}
	}
