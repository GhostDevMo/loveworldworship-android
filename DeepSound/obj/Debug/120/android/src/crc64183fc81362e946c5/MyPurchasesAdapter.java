...
public class MyPurchasesAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Library.Adapters.MyPurchasesAdapter, DeepSound", MyPurchasesAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MyPurchasesAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Library.Adapters.MyPurchasesAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public MyPurchasesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == MyPurchasesAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Library.Adapters.MyPurchasesAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
