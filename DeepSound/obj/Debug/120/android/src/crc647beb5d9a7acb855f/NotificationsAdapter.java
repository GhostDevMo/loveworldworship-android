...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Notification.Adapters.NotificationsAdapter, DeepSound", NotificationsAdapter.class, __md_methods);
	}
	...
	public NotificationsAdapter ()
	{
		...
		if (getClass () == NotificationsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Notification.Adapters.NotificationsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public NotificationsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == NotificationsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Notification.Adapters.NotificationsAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
