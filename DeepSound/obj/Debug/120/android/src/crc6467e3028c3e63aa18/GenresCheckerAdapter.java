...
public class GenresCheckerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Genres.Adapters.GenresCheckerAdapter, DeepSound", GenresCheckerAdapter.class, __md_methods);
	}


	public GenresCheckerAdapter ()
	{
		super ();
		if (getClass () == GenresCheckerAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Genres.Adapters.GenresCheckerAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public GenresCheckerAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == GenresCheckerAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Genres.Adapters.GenresCheckerAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
