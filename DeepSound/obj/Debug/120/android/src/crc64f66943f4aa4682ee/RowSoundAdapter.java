...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Songs.Adapters.RowSoundAdapter, DeepSound", RowSoundAdapter.class, __md_methods);
	}


	public RowSoundAdapter ()
	{
		super ();
		if (getClass () == RowSoundAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Songs.Adapters.RowSoundAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public RowSoundAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == RowSoundAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Songs.Adapters.RowSoundAdapter, DeepSound", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
