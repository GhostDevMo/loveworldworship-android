...
public class RowSoundLiteAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Songs.Adapters.RowSoundLiteAdapter, DeepSound", RowSoundLiteAdapter.class, __md_methods);
	}


	public RowSoundLiteAdapter ()
	{
		super ();
		if (getClass () == RowSoundLiteAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Songs.Adapters.RowSoundLiteAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public RowSoundLiteAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == RowSoundLiteAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Songs.Adapters.RowSoundLiteAdapter, DeepSound", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
