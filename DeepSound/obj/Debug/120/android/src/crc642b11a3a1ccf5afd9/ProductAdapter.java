...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Product.Adapters.ProductAdapter, DeepSound", ProductAdapter.class, __md_methods);
	}
	...
	public ProductAdapter ()
	{
		...
		if (getClass () == ProductAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Product.Adapters.ProductAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public ProductAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ProductAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Product.Adapters.ProductAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
