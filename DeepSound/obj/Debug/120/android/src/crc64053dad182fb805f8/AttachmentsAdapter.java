...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Playlist.Adapters.AttachmentsAdapter, DeepSound", AttachmentsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == AttachmentsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Playlist.Adapters.AttachmentsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public AttachmentsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == AttachmentsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Playlist.Adapters.AttachmentsAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
