...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Library.Anjo.SuperTextLibrary.XTouchableSpan, DeepSound", XTouchableSpan.class, __md_methods);
	}
	...
	public XTouchableSpan ()
	{
		...
		if (getClass () == XTouchableSpan.class)
			mono.android.TypeManager.Activate ("DeepSound.Library.Anjo.SuperTextLibrary.XTouchableSpan, DeepSound", "", this, new java.lang.Object[] {  });
	}
