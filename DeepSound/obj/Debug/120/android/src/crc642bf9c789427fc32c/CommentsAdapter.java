...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Comments.Adapters.CommentsAdapter, DeepSound", CommentsAdapter.class, __md_methods);
	}
	...
	public CommentsAdapter ()
	{
		...
		if (getClass () == CommentsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Comments.Adapters.CommentsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public CommentsAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == CommentsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Comments.Adapters.CommentsAdapter, DeepSound", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
