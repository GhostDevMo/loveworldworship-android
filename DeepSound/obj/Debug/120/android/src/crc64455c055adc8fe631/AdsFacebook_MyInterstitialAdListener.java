...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onInterstitialDismissed:(Lcom/facebook/ads/Ad;)V:GetOnInterstitialDismissed_Lcom_facebook_ads_Ad_Handler:Xamarin.Facebook.Ads.IInterstitialAdListenerInvoker, FacebookAudienceNetwork\n" +
			"n_onInterstitialDisplayed:(Lcom/facebook/ads/Ad;)V:GetOnInterstitialDisplayed_Lcom_facebook_ads_Ad_Handler:Xamarin.Facebook.Ads.IInterstitialAdListenerInvoker, FacebookAudienceNetwork\n" +
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Ads.AdsFacebook+MyInterstitialAdListener, DeepSound", AdsFacebook_MyInterstitialAdListener.class, __md_methods);
	}
	...
	public AdsFacebook_MyInterstitialAdListener ()
	{
		...
		if (getClass () == AdsFacebook_MyInterstitialAdListener.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsFacebook+MyInterstitialAdListener, DeepSound", "", this, new java.lang.Object[] {  });
	}
	...
	public AdsFacebook_MyInterstitialAdListener (android.app.Activity p0, com.facebook.ads.InterstitialAd p1)
	{
		super ();
		if (getClass () == AdsFacebook_MyInterstitialAdListener.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsFacebook+MyInterstitialAdListener, DeepSound", "Android.App.Activity, Mono.Android:Xamarin.Facebook.Ads.InterstitialAd, FacebookAudienceNetwork", this, new java.lang.Object[] { p0, p1 });
	}
