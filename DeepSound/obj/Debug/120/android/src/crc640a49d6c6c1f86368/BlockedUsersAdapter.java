...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.SettingsUser.Adapters.BlockedUsersAdapter, DeepSound", BlockedUsersAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == BlockedUsersAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.SettingsUser.Adapters.BlockedUsersAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public BlockedUsersAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == BlockedUsersAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.SettingsUser.Adapters.BlockedUsersAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
