...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Songs.Adapters.HSoundAdapter, DeepSound", HSoundAdapter.class, __md_methods);
	}


	public HSoundAdapter ()
	{
		super ();
		if (getClass () == HSoundAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Songs.Adapters.HSoundAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public HSoundAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == HSoundAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Songs.Adapters.HSoundAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
