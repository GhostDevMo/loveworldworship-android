...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Playlist.Adapters.PlaylistAdapter, DeepSound", PlaylistAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PlaylistAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Playlist.Adapters.PlaylistAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public PlaylistAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == PlaylistAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Playlist.Adapters.PlaylistAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
