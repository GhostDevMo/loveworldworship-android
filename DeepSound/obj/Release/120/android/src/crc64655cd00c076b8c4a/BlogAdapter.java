...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Blog.Adapters.BlogAdapter, DeepSound", BlogAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == BlogAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Blog.Adapters.BlogAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public BlogAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == BlogAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Blog.Adapters.BlogAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
