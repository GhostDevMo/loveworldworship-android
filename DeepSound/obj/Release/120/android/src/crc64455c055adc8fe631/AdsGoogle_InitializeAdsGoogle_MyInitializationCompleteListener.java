...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Ads.AdsGoogle+InitializeAdsGoogle+MyInitializationCompleteListener, DeepSound", AdsGoogle_InitializeAdsGoogle_MyInitializationCompleteListener.class, __md_methods);
	}
	...
	public AdsGoogle_InitializeAdsGoogle_MyInitializationCompleteListener ()
	{
		...
		if (getClass () == AdsGoogle_InitializeAdsGoogle_MyInitializationCompleteListener.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsGoogle+InitializeAdsGoogle+MyInitializationCompleteListener, DeepSound", "", this, new java.lang.Object[] {  });
	}
