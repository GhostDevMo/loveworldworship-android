...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Ads.AdsColony+MyAdColonyAdViewListener, DeepSound", AdsColony_MyAdColonyAdViewListener.class, __md_methods);
	}
	...
	public AdsColony_MyAdColonyAdViewListener ()
	{
		...
		if (getClass () == AdsColony_MyAdColonyAdViewListener.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsColony+MyAdColonyAdViewListener, DeepSound", "", this, new java.lang.Object[] {  });
	}
	...
	public AdsColony_MyAdColonyAdViewListener (android.widget.LinearLayout p0, androidx.recyclerview.widget.RecyclerView p1)
	{
		super ();
		if (getClass () == AdsColony_MyAdColonyAdViewListener.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsColony+MyAdColonyAdViewListener, DeepSound", "Android.Widget.LinearLayout, Mono.Android:AndroidX.RecyclerView.Widget.RecyclerView, Xamarin.AndroidX.RecyclerView", this, new java.lang.Object[] { p0, p1 });
	}
