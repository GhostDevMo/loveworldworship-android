...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Ads.AdsGoogle+MyAdListener, DeepSound", AdsGoogle_MyAdListener.class, __md_methods);
	}
	...
	public AdsGoogle_MyAdListener ()
	{
		...
		if (getClass () == AdsGoogle_MyAdListener.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsGoogle+MyAdListener, DeepSound", "", this, new java.lang.Object[] {  });
	}
	...
	public AdsGoogle_MyAdListener (com.google.android.gms.ads.AdView p0, androidx.recyclerview.widget.RecyclerView p1)
	{
		super ();
		if (getClass () == AdsGoogle_MyAdListener.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsGoogle+MyAdListener, DeepSound", "Android.Gms.Ads.AdView, Xamarin.GooglePlayServices.Ads.Lite:AndroidX.RecyclerView.Widget.RecyclerView, Xamarin.AndroidX.RecyclerView", this, new java.lang.Object[] { p0, p1 });
	}
