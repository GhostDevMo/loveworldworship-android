...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Ads.AdsColony+MyAdColonyRewardedListener, DeepSound", AdsColony_MyAdColonyRewardedListener.class, __md_methods);
	}
	...
	public AdsColony_MyAdColonyRewardedListener ()
	{
		...
		if (getClass () == AdsColony_MyAdColonyRewardedListener.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsColony+MyAdColonyRewardedListener, DeepSound", "", this, new java.lang.Object[] {  });
	}
	...
	public AdsColony_MyAdColonyRewardedListener (com.adcolony.sdk.AdColonyAdOptions p0)
	{
		super ();
		if (getClass () == AdsColony_MyAdColonyRewardedListener.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsColony+MyAdColonyRewardedListener, DeepSound", "Com.Adcolony.Sdk.AdColonyAdOptions, AdColonySdk", this, new java.lang.Object[] { p0 });
	}
