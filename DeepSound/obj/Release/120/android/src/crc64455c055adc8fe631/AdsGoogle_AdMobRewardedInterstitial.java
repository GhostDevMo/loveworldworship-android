...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Ads.AdsGoogle+AdMobRewardedInterstitial, DeepSound", AdsGoogle_AdMobRewardedInterstitial.class, __md_methods);
	}
	...
	public AdsGoogle_AdMobRewardedInterstitial ()
	{
		...
		if (getClass () == AdsGoogle_AdMobRewardedInterstitial.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Ads.AdsGoogle+AdMobRewardedInterstitial, DeepSound", "", this, new java.lang.Object[] {  });
	}
