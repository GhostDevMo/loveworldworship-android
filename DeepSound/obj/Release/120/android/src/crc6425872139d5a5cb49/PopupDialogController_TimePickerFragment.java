...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Controller.PopupDialogController+TimePickerFragment, DeepSound", PopupDialogController_TimePickerFragment.class, __md_methods);
	}
	...
	public PopupDialogController_TimePickerFragment ()
	{
		...
		if (getClass () == PopupDialogController_TimePickerFragment.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Controller.PopupDialogController+TimePickerFragment, DeepSound", "", this, new java.lang.Object[] {  });
	}
	...
	public PopupDialogController_TimePickerFragment (int p0)
	{
		super (p0);
		if (getClass () == PopupDialogController_TimePickerFragment.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Controller.PopupDialogController+TimePickerFragment, DeepSound", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
	}
