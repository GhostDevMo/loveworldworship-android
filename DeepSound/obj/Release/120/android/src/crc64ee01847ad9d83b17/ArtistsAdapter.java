...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Artists.Adapters.ArtistsAdapter, DeepSound", ArtistsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ArtistsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Artists.Adapters.ArtistsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public ArtistsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ArtistsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Artists.Adapters.ArtistsAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
