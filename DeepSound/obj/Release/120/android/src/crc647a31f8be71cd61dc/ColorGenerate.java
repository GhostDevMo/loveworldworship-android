...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.CacheLoaders.ColorGenerate, DeepSound", ColorGenerate.class, __md_methods);
	}
	...
	public ColorGenerate ()
	{
		...
		if (getClass () == ColorGenerate.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.CacheLoaders.ColorGenerate, DeepSound", "", this, new java.lang.Object[] {  });
	}
	...
	public ColorGenerate (int p0, int p1)
	{
		super (p0, p1);
		if (getClass () == ColorGenerate.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.CacheLoaders.ColorGenerate, DeepSound", "System.Int32, mscorlib:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public ColorGenerate (android.app.Activity p0, android.widget.ImageView p1)
	{
		super ();
		if (getClass () == ColorGenerate.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.CacheLoaders.ColorGenerate, DeepSound", "Android.App.Activity, Mono.Android:Android.Widget.ImageView, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
