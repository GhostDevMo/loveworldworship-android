...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.CacheLoaders.GlideCircleWithBorder, DeepSound", GlideCircleWithBorder.class, __md_methods);
	}
	...
	public GlideCircleWithBorder ()
	{
		...
		if (getClass () == GlideCircleWithBorder.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.CacheLoaders.GlideCircleWithBorder, DeepSound", "", this, new java.lang.Object[] {  });
	}
