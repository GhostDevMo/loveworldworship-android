...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Helpers.Utils.Methods+AppLifecycleObserver, DeepSound", Methods_AppLifecycleObserver.class, __md_methods);
	}
	...
	public Methods_AppLifecycleObserver ()
	{
		...
		if (getClass () == Methods_AppLifecycleObserver.class)
			mono.android.TypeManager.Activate ("DeepSound.Helpers.Utils.Methods+AppLifecycleObserver, DeepSound", "", this, new java.lang.Object[] {  });
	}
