...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Chat.Adapters.LastChatAdapter, DeepSound", LastChatAdapter.class, __md_methods);
	}


	public LastChatAdapter ()
	{
		super ();
		if (getClass () == LastChatAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Chat.Adapters.LastChatAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public LastChatAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == LastChatAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Chat.Adapters.LastChatAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
