...
public class LastSearchAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Search.Adapters.LastSearchAdapter, DeepSound", LastSearchAdapter.class, __md_methods);
	}


	public LastSearchAdapter ()
	{
		super ();
		if (getClass () == LastSearchAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Search.Adapters.LastSearchAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public LastSearchAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == LastSearchAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Search.Adapters.LastSearchAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
