...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Payment.InitCashFreePayment+MyWebViewClient, DeepSound", InitCashFreePayment_MyWebViewClient.class, __md_methods);
	}
	...
	public InitCashFreePayment_MyWebViewClient ()
	{
		...
		if (getClass () == InitCashFreePayment_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("DeepSound.Payment.InitCashFreePayment+MyWebViewClient, DeepSound", "", this, new java.lang.Object[] {  });
	}
