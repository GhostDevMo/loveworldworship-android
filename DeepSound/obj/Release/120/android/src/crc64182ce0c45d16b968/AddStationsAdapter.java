...
public class AddStationsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DeepSound.Activities.Stations.Adapters.AddStationsAdapter, DeepSound", AddStationsAdapter.class, __md_methods);
	}


	public AddStationsAdapter ()
	{
		super ();
		if (getClass () == AddStationsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Stations.Adapters.AddStationsAdapter, DeepSound", "", this, new java.lang.Object[] {  });
	}

	public AddStationsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == AddStationsAdapter.class)
			mono.android.TypeManager.Activate ("DeepSound.Activities.Stations.Adapters.AddStationsAdapter, DeepSound", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
